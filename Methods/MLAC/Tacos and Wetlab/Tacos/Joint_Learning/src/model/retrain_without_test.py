...
tf.app.flags.DEFINE_float(
    "learning_rate", 1e-6, """How large a learning rate to use when training."""
)
tf.app.flags.DEFINE_integer(
...
def train():
    ...
    # Create the operations we need to evaluate the accuracy of new layer.
    ...
    # Set up all weights to their initial default values.
    ...
    # We've completed all training, so run a final test evaluation on
