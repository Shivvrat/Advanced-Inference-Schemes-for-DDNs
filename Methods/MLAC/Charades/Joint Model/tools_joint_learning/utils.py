...
def plot_losses(val_losses, each_true_label, params_string, train_losses=None):
    ...
    plt.savefig(f'{folder}plot_for_{each_true_label}.pdf')
    # plt.show()
...
def import_from_pickle_file(file_location):
    from dn.model_class_scratch_lr.logistic_regression.model import LogisticRegression
