...
# Path to Detectron2 object detection model pre_trained weights.
...
# ---------------------------------------------------------------------------- #
# Joint Learning options
# ---------------------------------------------------------------------------- #

_C.DEBUG = False

_C.JOINT_LEARNING = CfgNode()

_C.JOINT_LEARNING.PRETRAINED = False
_C.JOINT_LEARNING.MODEL_DIRECTORY = ""
_C.JOINT_LEARNING.LEARNING_RATE = 0.01
_C.JOINT_LEARNING.L1_WEIGHT = 0.001
_C.JOINT_LEARNING.EXTRA_EPOCHS = 3
_C.JOINT_LEARNING.TWO_LOSSES = False
_C.JOINT_LEARNING.WEIGHT_DECAY = 0.01
_C.JOINT_LEARNING.DN_TYPE = "nn"

# _C.JOINT_LEARNING =
# Add custom config with default values.
custom_config.add_custom_config(_C)

_C.DN_INFERENCE = CfgNode()

_C.DN_INFERENCE.NUM_SAMPLES = 1000
_C.DN_INFERENCE.NUM_POOLS = 10
_C.DN_INFERENCE.BATCH_SIZE = 64

# _C.DN_INFERENCE.LEARNING_RATE = 0.01
# _C.DN_INFERENCE.L1_WEIGHT = 0.001
